...
A. That's on you to test the script and describe the errors you see, do not create an issue in Github that does not contain an issue or create an issue without any actual diagnosis information or error messages.
