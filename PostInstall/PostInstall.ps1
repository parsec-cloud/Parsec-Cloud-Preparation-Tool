...
(New-Object System.Net.WebClient).DownloadFile(https://github.com/jamesstringerparsec/Parsec-Service-Manager/blob/master/ParsecServiceManager.exe", "$ENV:UserProfile\Desktop\ParsecServiceManager.exe") | Unblock-File
}
