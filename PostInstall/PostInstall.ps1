...
(New-Object System.Net.WebClient).DownloadFile("https://github.com/jamesstringerparsec/Parsec-Authenticator-for-RDP/raw/master/ParsecAuth.exe", "$ENV:UserProfile\Desktop\ParsecAuth.exe") | Unblock-File
}
